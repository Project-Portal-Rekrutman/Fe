...
let index = (props) => {
    return (
        <nav className="navbar navbar-expand-md navbar-light d-flex ">
            ...
            <a className="navbar-brand" href="index.html"><img src={props.logo} alt="admin template" style={{ maxWidth: '50%', height: '40%' }} /></a>
            <div className="collapse navbar-collapse" id="navbarNavDropdown">
                <ul className="navbar-nav ml-auto stylish-nav">
                    ...
                    <li className="nav-item"> <Link  to={`/my-app`} className={"text-decoration-none"}>My Application</Link> </li>
